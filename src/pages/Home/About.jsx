...
const About = () => {
  return (
    <Container className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 h-full  my-20 gap-8 md:gap-0">
      <div
        className="lg:col-span-3 flex flex-col gap-4 
   justify-center text-center md:text-left"
      >
        <h3 className="font-medium text-[#808080] text-md text-sm">About Us</h3>
      ...
      <div className="h-full lg:col-span-2 flex gap-2 justify-center ">
        <div className=" ">
