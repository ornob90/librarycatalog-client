...
const About = () => {
  return (
    <div className="dark:bg-dark-mode pb-1">
      <Container className="">
        <SectionHeader
          header="About US"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 h-full  my-20 gap-8 md:gap-0">
          ...
          <div className="lg:col-span-2 flex flex-col gap-4 justify-center text-center md:text-left">
            ...
            <p className="dark:text-dark-accent text-[#808080] text-[13px] w-3/4 mx-auto md:m-0 lg:w-3/4 text-center md:text-left">
            ...
            <div>
              <Button className="dark:bg-dark-text dark:text-dark-mode bg-black text-white py-1 px-6 md:py-2 md:px-8 rounded-sm text-sm md:text-base mt-2">
                Explore
              </Button>
            </div>
          </div>
